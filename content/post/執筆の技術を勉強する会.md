...
# 個人的なまとめ
とりあえず、[Re:VIEW](https://github.com/kmuto/review)を触ってみるのを本当に書きはじめる前にしたほうが良さそうですね。  
...
また、[#engineers_lt](https://twitter.com/hashtag/engineers_lt?src=hash)の勉強会に参加すると日本酒を知ることができるという副作用があるので、どんどん日本酒が好きになってしまいそうです…w
